...
public class Servicebranch extends ServicebranchEntity {

    @Override
    public ServicebranchEntity create() throws TipsException {
    ...
    @Override
    public ServicebranchEntity update() throws TipsException {
        String orgId = this.getOrgId();
        String departMentId = this.getDepartmentId();
        OrganizationEntity organizationEntity = new Organization();
        organizationEntity.setId(orgId);
